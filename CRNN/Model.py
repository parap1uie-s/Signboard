...
def ResNet(input_shape,architecture='resnet50'):
    ...
    gru_1 = KL.GRU(256, return_sequences=False, name='gru1', activation='relu')(x)
    gru_1b = KL.GRU(256, return_sequences=False, go_backwards=True, name='gru1_b', activation='relu')(x)
