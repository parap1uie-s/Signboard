...
sudo python3 keras_retinanet/bin/train.py --weights=resnet50_coco_best_v2.1.0.h5 --batch-size=2 --steps=1000 csv train_annotations.csv classes.csv --val-annotations=val_annotations.csv